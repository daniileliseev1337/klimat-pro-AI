...
**Обновлено: 2026-07-03, вечер** (сессия: аудит + инцидент туннеля + гигиена + SQL-пакет + онбординг Этап 1 в проде)

## Прод
- Живой: https://193-124-130-236.sslip.io — HTTP 200 снаружи (проверено exa) и на nginx :8080.
- Версия: **c2ef665** (merge онбординга Этап 1, asset `index-DMAw321r.js`, задеплоен 03.07, HTTP 200 снаружи). GitHub origin/main = локальный main.
