...
- 🔧 **Онбординг-навигатор**: brainstorm начат 03.07 (3 варианта BACKLOG §4; фундамент — CommandPalette).
  Решение владельца — см. итог brainstorm в этом файле, когда появится.
