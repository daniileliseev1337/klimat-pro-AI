...
- 🟡 **Умный импорт выписки Яндекс Банка v2 (В РАБОТЕ — spec одобрен 04.07)**. Brainstorm проведён: real-time
  ...
  Spec: `docs/superpowers/specs/2026-07-04-bank-import-v2-design.md`. Следующий шаг: **writing-plans** →
  реализация. Вне scope: LLM-слой (только интерфейс), Сбер/Альфа/Тинькофф.
