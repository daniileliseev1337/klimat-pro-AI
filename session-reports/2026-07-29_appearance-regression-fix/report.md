...
- Внешний HTTPS через WSL: HTML=200, `index-DjaZC-_-.js`=200, `index-DegNOVBM.css`=200. Windows-запрос с активным VPN дал локальный timeout, но frpc active и внешний маршрут независимо подтверждён.
